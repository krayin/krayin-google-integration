<x-admin::layouts>
    ...
    {!! view_render_event('admin.activities.edit.form.before', ['activity' => $activity]) !!}
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    <div class="flex items-center gap-x-2.5">
                        {!! view_render_event('admin.activities.edit.submit-btn.before', ['activity' => $activity]) !!}
                        ...
                        {!! view_render_event('admin.activities.edit.submit-btn.after', ['activity' => $activity]) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    {!! view_render_event('admin.activities.edit.accordion.general.before', ['activity' => $activity]) !!}
                    ...
                    {!! view_render_event('admin.activities.edit.accordion.general.after', ['activity' => $activity]) !!}
                </div>
            </div>
        </div>
    </x-admin::form>

    {!! view_render_event('admin.activities.edit.form.after', ['activity' => $activity]) !!}
